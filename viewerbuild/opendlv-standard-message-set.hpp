...
#ifndef OPENDLV_PROXY_ORBSLAMMAP_HPP
#define OPENDLV_PROXY_ORBSLAMMAP_HPP
...
namespace opendlv { namespace proxy {
using namespace std::string_literals; // NOLINT
class LIB_API OrbslamMap {
    public:
        OrbslamMap() = default;
        OrbslamMap(const OrbslamMap&) = default;
        OrbslamMap& operator=(const OrbslamMap&) = default;
        OrbslamMap(OrbslamMap&&) noexcept = default; // NOLINT
        OrbslamMap& operator=(OrbslamMap&&) noexcept = default; // NOLINT
        ~OrbslamMap() = default;
    ...
    public:
        ...
        OrbslamMap& cameraCoordinates(const std::string &v) noexcept;
        std::string cameraCoordinates() const noexcept;
        
        OrbslamMap& cameraRotation(const std::string &v) noexcept;
        std::string cameraRotation() const noexcept;
        
        OrbslamMap& mapCoordinateIndex(const uint32_t &v) noexcept;
        uint32_t mapCoordinateIndex() const noexcept;
        
        OrbslamMap& mapCoordinates(const std::string &v) noexcept;
        std::string mapCoordinates() const noexcept;
        ...
        void accept(Visitor &visitor) {
            ...
            doVisit(1, std::move("std::string"s), std::move("cameraCoordinates"s), m_cameraCoordinates, visitor);
            
            doVisit(2, std::move("std::string"s), std::move("cameraRotation"s), m_cameraRotation, visitor);
            
            doVisit(3, std::move("uint32_t"s), std::move("mapCoordinateIndex"s), m_mapCoordinateIndex, visitor);
            
            doVisit(4, std::move("std::string"s), std::move("mapCoordinates"s), m_mapCoordinates, visitor);
        ...
        void accept(PreVisitor &&preVisit, Visitor &&visit, PostVisitor &&postVisit) {
            ...
            doTripletForwardVisit(1, std::move("std::string"s), std::move("cameraCoordinates"s), m_cameraCoordinates, preVisit, visit, postVisit);
            
            doTripletForwardVisit(2, std::move("std::string"s), std::move("cameraRotation"s), m_cameraRotation, preVisit, visit, postVisit);
            
            doTripletForwardVisit(3, std::move("uint32_t"s), std::move("mapCoordinateIndex"s), m_mapCoordinateIndex, preVisit, visit, postVisit);
            
            doTripletForwardVisit(4, std::move("std::string"s), std::move("mapCoordinates"s), m_mapCoordinates, preVisit, visit, postVisit);
    ...
    private:
        ...
        std::string m_cameraCoordinates{ ""s }; // field identifier = 1.
        
        std::string m_cameraRotation{ ""s }; // field identifier = 2.
        
        uint32_t m_mapCoordinateIndex{ 0 }; // field identifier = 3.
        
        std::string m_mapCoordinates{ ""s }; // field identifier = 4.
        
};
}}

template<>
struct isVisitable<opendlv::proxy::OrbslamMap> {
    static const bool value = true;
};
template<>
struct isTripletForwardVisitable<opendlv::proxy::OrbslamMap> {
    static const bool value = true;
};
#endif
