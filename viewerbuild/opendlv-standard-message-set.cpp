...
int32_t OrbslamMap::ID() {
    return 1193;
}

const std::string OrbslamMap::ShortName() {
    return "OrbslamMap";
}
const std::string OrbslamMap::LongName() {
    return "opendlv.proxy.OrbslamMap";
}

OrbslamMap& OrbslamMap::cameraCoordinates(const std::string &v) noexcept {
    m_cameraCoordinates = v;
    return *this;
}
std::string OrbslamMap::cameraCoordinates() const noexcept {
    return m_cameraCoordinates;
}

OrbslamMap& OrbslamMap::cameraRotation(const std::string &v) noexcept {
    m_cameraRotation = v;
    return *this;
}
std::string OrbslamMap::cameraRotation() const noexcept {
    return m_cameraRotation;
}

OrbslamMap& OrbslamMap::mapCoordinateIndex(const uint32_t &v) noexcept {
    m_mapCoordinateIndex = v;
    return *this;
}
uint32_t OrbslamMap::mapCoordinateIndex() const noexcept {
    return m_mapCoordinateIndex;
}

OrbslamMap& OrbslamMap::mapCoordinates(const std::string &v) noexcept {
    m_mapCoordinates = v;
    return *this;
}
std::string OrbslamMap::mapCoordinates() const noexcept {
    return m_mapCoordinates;
}
